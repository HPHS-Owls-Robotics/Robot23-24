...
Once you have downloaded and uncompressed (if needed) your folder, you can use Android Studio to import the
## Getting Help
### User Documentation and Tutorials folder  ("Import project (Eclipse ADT, Gradle, etc.)").
